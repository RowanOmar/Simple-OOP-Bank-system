        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(pressed.equals(button1))
            {
                ...
                try {
                    ...
                    Logger.getLogger(WithdrawGui.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                WithdrawThread D=new WithdrawThread(customer,amountt,Teller);
                D.start();
                JOptionPane.showMessageDialog(null, "The Amount was withdrawn successfully");                  
            }
