 ...
 * @author fatma
 */
public class GuiDisplayEmployee extends JPanel{
    JLabel label1;
    JLabel label2;
    JLabel label3;
    JLabel label4;
   ...
   public GuiDisplayEmployee(){
       ...
       setLayout(null);
        ...
        label10=new JLabel("Salary: ");
        label10.setBounds(5, 250, 150, 30);
        add(label10);
        l10=new JLabel("");
        l10.setBounds(120, 250, 170, 30);
        l10.setForeground(Color.red);
        add(l10);
        
       
        
        label9=new JLabel("Enter ID : ");
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(pressed.equals(button1))
            {
                String IDD=text1.getText();
                    ...
                    employee=admin.DisplayEmployee(ID);
                    String firstn=employee.getFirstName();
                    String lastn=employee.getLastName();
                    String address=employee.getAdress();
                    String usern=employee.getUserName();
                    String password=employee.getPassword();
                    String email=employee.getEmail();
                    long mobilen=employee.getMobileNumber();
                    String mobilenumber=Long.toString(mobilen);
                    int homen=employee.getHomeNumber();
                    String homenum=Integer.toString(homen);
                    Double salary=employee.getSalary();
                    String salaryy=Double.toString(salary);
                    l1.setText(firstn);
                    l2.setText(lastn);
                    l3.setText(address);
...
//	GuiDisplayEmployee form = new GuiDisplayEmployee();
//        JFrame frame=new JFrame();
//	frame.setTitle("Display Employee");
